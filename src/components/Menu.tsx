  ...
  const menuCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "كي��ي بسطرة", description: "", price: "12 ج.م" },
    ...
    },
    {
      ...
      image: drinksMenuImage,
      items: [
        { name: "بيبسي", description: "", price: "40 ج.م" },
        { name: "سفن أب", description: "", price: "40 ج.م" },
        { name: "ميرندا برتقال", description: "", price: "40 ج.م" },
        { name: "ميرندا مانجو", description: "", price: "40 ج.م" },
        { name: "مياه معدنية", description: "", price: "20 ج.م" },
        { name: "ريد بول", description: "", price: "80 ج.م" },
        { name: "ريد بول تروبيكال", description: "", price: "80 ج.م" },
        { name: "ريد بول خوخ", description: "", price: "80 ج.م" },
      ],
    },
  ]
