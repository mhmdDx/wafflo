  ...
  const menuCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "كيري رومي", description: "", price: "15 ج.م" },
        { name: "شيدر", description: "", price: "10 ج.م" },
        { name: "شيدر بسطرمه", description: "", price: "12 ج.م" },
        { name: "تونة", description: "", price: "15 ج.م" },
        { name: "سلطة تونة", description: "", price: "20 ج.م" },
        { name: "رومي", description: "", price: "10 ج.م" },
        { name: "لانشون", description: "", price: "10 ج.م" },
        { name: "رومي لانشون", description: "", price: "15 ج.م" },
        { name: "قشطه رومي", description: "", price: "15 ج.م" },
        { name: "رومي موتزريلا", description: "", price: "15 ج.م" },
        { name: "رومي لانشون موتزريلا", description: "", price: "20 ج.م" },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "بلوبيف", description: "", price: "15 ج.م" },
        { name: "سجق مشوي", description: "", price: "18 ج.م" },
        { name: "سجق خلطة", description: "", price: "15 ج.م" },
        { name: "سوسيس", description: "", price: "15 ج.م" },
        { name: "لحمة بالبصل", description: "", price: "17 ج.م" },
        { name: "بسطرة بالصلصة", description: "", price: "17 ج.م" },
        { name: "فهيتا لحوم", description: "", price: "20 ج.م" },
        { name: "سجق موتزريلا", description: "", price: "20 ج.م" },
        { name: "استريبس موتزريلا", description: "", price: "23 ج.م" },
      ],
    },
